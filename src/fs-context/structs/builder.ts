import { Builder, BuilderExcludedKeys } from './interface';
import { BlockMetadata, MenuMetadata, ExtensionMetadata, MenuItem, LoaderMetadata, TranslatorMetadata } from './metadata';
...
> extends BuilderExcludedKeys<ExtensionMetadata<B, M, L>, 'translators' | 'blocks' | 'menus' | 'loaders'> {
